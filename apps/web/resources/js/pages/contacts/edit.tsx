...
export default function Edit({ contact, accounts, users, contacts }: Props) {
    ...
    const { data, setData, put, processing, errors, transform } = useForm<{
        ...
        account_id: contact.account_id?.toString() || 'none',
        title: contact.title || '',
        ...
        fax: contact.fax || '',
        reports_to: contact.reports_to?.toString() || 'none',
        ...
        assigned_to: contact.assigned_to?.toString() || 'none',
