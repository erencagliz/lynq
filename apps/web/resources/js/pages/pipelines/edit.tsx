...
export default function Edit({ pipeline }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm<{
        name: string;
        stages: { id?: number; name: string; probability: number }[];
    }>({
        name: pipeline.name,
    ...
    const addStage = () => {
        setData('stages', [
            ...data.stages,
            { id: undefined, name: '', probability: 0 },
        ]);
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto flex h-full w-full max-w-4xl flex-1 flex-col gap-4 p-4">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-semibold">Edit Pipeline</h1>
                </div>
                    ...
                    <div className="flex items-center justify-between">
                        <Button
                            ...
                            onClick={() => {
                                if (
                                    confirm(
                                        'Are you sure you want to delete this pipeline? All deals in this pipeline will be lost.',
                                    )
                                ) {
