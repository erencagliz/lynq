...
import { Account, BreadcrumbItem, Contact, Pipeline } from '@/types';
...
export default function Create({ accounts, contacts, pipelines }: Props) {
    ...
    const { data, setData, post, processing, errors } = useForm<{
        ...
        name: '',
        pipeline_id: defaultPipeline?.id.toString() || '',
        pipeline_stage_id: defaultStage?.id.toString() || '',
        account_id: '',
        contact_id: '',
        value: 0,
        currency: 'USD',
